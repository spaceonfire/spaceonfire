...
interface CollectionInterface extends \IteratorAggregate, \Countable, \JsonSerializable
{
     ...
     * @return static<V>
     */
    public function merge(iterable ...$collections): self;
...
//    public function indexBy(?FieldInterface $field): MapInterface;
//
//    public function groupBy(?FieldInterface $field): MapInterface;
