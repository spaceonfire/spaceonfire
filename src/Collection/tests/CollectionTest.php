...
class CollectionTest extends TestCase
{
    ...
    public function testNewValueType(): void
    {
        $this->expectException(\LogicException::class);

        \iterator_to_array(Collection::new(\range(0, 8), new BuiltinType(BuiltinType::STRING)));
    }
    ...
    {
        $this->expectException(\LogicException::class);
        $collection = Collection::new([], new BuiltinType(BuiltinType::STRING));
        $collection->add(1);
    }
    ...
    {
        $this->expectException(\LogicException::class);
        $collection = Collection::new(\range(0, 9), new BuiltinType(BuiltinType::INT));
        $collection->remove('0');
    }
    ...
    public function testAverage(): void
    {
        ...
        self::assertEqualsWithDelta(2, $collection->average(new YiiArrayField('field')), PHP_FLOAT_EPSILON);
    }
    ...
    public function testMax(): void
    {
        ...
        self::assertEquals(3, $collection->max(new YiiArrayField('field')));
    }
    ...
    public function testMin(): void
    {
        ...
        self::assertEquals(-3, $collection->min(new YiiArrayField('field')));
    }
    ...
    public function testClone(): void
    {
        ...
        self::assertNotSame($collection, $clone);
        self::assertNotSame($collection->getIterator(), $clone->getIterator());
    }
    ...
    private function skipWithXdebug(): void
    {
